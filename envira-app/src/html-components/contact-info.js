        ...
        data-aos="fade-left" data-aos-once>
            <div className="flex flex-col gap-2 justify-center"> 
                <p className="contact-info-outline font-sfproBold text-3xl"><svg xmlns="http://www.w3.org/2000/svg"
                         className="h-8 w-8 mx-1" viewBox="0 0 20 20" fill="currentColor">
                ...
                <p className="contact-info-outline font-sfproMed text-sm "><svg xmlns="http://www.w3.org/2000/svg"
                         className="h-6 w-6 mx-1" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10
